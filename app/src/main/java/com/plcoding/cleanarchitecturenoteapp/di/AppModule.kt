...
@Module
@InstallIn(SingletonComponent::class) // gets attached into the whole lifeCycle of the app
object AppModule {

    //@Provides
    // all of this dependencies get attached to the lifeCycle of the component that creates this module
